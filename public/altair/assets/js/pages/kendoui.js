            ...
            $kUI_autocomplete_template.kendoAutoComplete({
                ...
                '<div class="k-list-wrapper">'+
                    '<span class="k-state-default k-list-wrapper-addon">' +
                        '<img src=\"altair/assets/img/avatars/avatar_#:data.CustomerID#_tn.png\" alt=\"#:data.CustomerID#\" />' +
                    '</span>' +
        ...
        if($kUI_multiselect_custom_template.length) {
            $kUI_multiselect_custom_template.kendoMultiSelect({
                ...
                itemTemplate:
                    ...
                    '</div>',
                tagTemplate:
                    '<img class="k-tag-image" src=\"altair/assets/img/avatars/avatar_#:data.CustomerID#_tn.png\" alt=\"${data.CustomerID}\" />' +
                    '#: data.ContactName #',
                dataSource: {
                    transport: {
                        read: {
                            dataType: "json",
                            url: "altair/data/kUI_users_data.min.json"
                        }
                    }
                },
                value: [
