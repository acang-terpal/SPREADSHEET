            ...
            var invoice_id = parseInt($this.attr('data-invoice-id')),
                context = {
                    invoice: {
                        ...
                        invoice_due_date:       moment().format('DD.MM.YYYY'),
                        invoice_from_company:   'Hasan',
                        invoice_from_address_1: 'Geriya Selaras',
                        invoice_from_address_2: 'Bogor',
                        invoice_to_company:     'PT.Sains Analitika Prima',
                        invoice_to_address_1:   'Ruko Green Residence No. 08 Jl. Pangeran Sogiri, Kelurahan Tanah Baru',
                        invoice_to_address_2:   'Bogor',
                        invoice_total_value:    'Rp.75.000.000,00',
                        invoice_vat_value:      'Rp.0,00',
                        invoice_services: [
                            {
                                service_name:           "Website design & development UP Customer",
                                service_description:    "Phase One Development for Uji Profisiensi Customer Web Apps",
                                service_rate:           "Rp.0,00",
                                service_hours:          "32",
                                service_vat:            "0%",
                                service_total:          "Rp.75.000.000,00"
                            }
                            // ,
                            // {
                        ...
                        invoice_payment_info:   'BANK BCA<br/>0083-080-385</br>Muhammad Hasan Mustofa',
                        invoice_payment_due:    '1',
