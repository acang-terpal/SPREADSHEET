...
<meta charset="UTF-8">
    ...
    <!--[if lte IE 9]>
        <script type="text/javascript" src="altair/bower_componentsmatchMedia/matchMedia.js"></script>
        <script type="text/javascript" src="altair/bower_componentsmatchMedia/matchMedia.addListener.js"></script>
...
@section('script_bottom')
    ...
    <script src="altair/assets/js/pages/forms_validation.min.js"></script>
