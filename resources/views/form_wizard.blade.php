...
@section('head')
    ...
    <!--[if lte IE 9]>
        ...
        <link rel="stylesheet" href="altair/altair/assets/css/ie.css" media="all">
    <![endif]-->   
@endsection
                                    ...
                                    <div class="uk-width-medium-1-3 parsley-row">
                                        <select id="wizard_birth_place" name="wizard_birth_place" required>
                                            <option value="">Place of Birth</option>
                                                                                            <option value="city_0">East Dorcastown</option>
                                                                                            <option value="city_1">Port Marcus</option>
                                                                                            <option value="city_2">Bruenton</option>
                                                                                            <option value="city_3">South Thomasmouth</option>
                                                                                            <option value="city_4">South Christopheview</option>
                                                                                            <option value="city_5">Idaview</option>
                                                                                            <option value="city_6">North Maraland</option>
                                                                                            <option value="city_7">New Dorothy</option>
                                                                                            <option value="city_8">Morgantown</option>
                                                                                            <option value="city_9">Emardside</option>
                                                                                            <option value="city_10">South Juvenalfort</option>
                                                                                            <option value="city_11">Gillianborough</option>
                                                                                            <option value="city_12">Priscillahaven</option>
                                                                                            <option value="city_13">Tinaside</option>
                                                                                            <option value="city_14">Tyshawnburgh</option>
                                                                                            <option value="city_15">Tiaraport</option>
                                                                                            <option value="city_16">South Aubrey</option>
                                                                                            <option value="city_17">Jonathonfurt</option>
                                                                                            <option value="city_18">Cruickshankshire</option>
                                                                                            <option value="city_19">East Avery</option>
                                                                                    </select>
                                    </div>
                                    <div class="uk-width-medium-1-3 parsley-row">
...
@section('script_bottom')
    ...
    <!-- jquery steps -->
    <script src="altair/assets/js/custom/wizard_steps.min.js"></script>

    <!--  forms wizard functions -->
    <script src="altair/assets/js/pages/forms_wizard.min.js"></script>
