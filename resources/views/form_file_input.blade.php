                    ...
                    <div class="uk-width-medium-1-2">
                        <div class="md-card">
                            <div class="md-card-content">
                                ...
                                <input type="file" id="input-file-b" class="dropify" data-default-file="altair/assets/img/gallery/Image08.jpg"/>
                            </div>
                        </div>
                    </div>
                </div>
...
@section('script_bottom')
    <!-- google web fonts -->
        ...
        <!--  dropify -->
        <script src="altair/assets/js/custom/dropify/dist/js/dropify.min.js"></script>
