                                    ...
                                    <ul id="header_alerts" class="uk-switcher uk-margin">
                                        <li>
                                            <ul class="md-list md-list-addon">
                                                ...
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <span class="md-user-letters md-bg-light-green">kd</span>
                                                    </div>
                                                    <div class="md-list-content">
                                        ...
                                        <li>
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Eius enim.</span>
                                                        <span
                                                            class="uk-text-small uk-text-muted uk-text-truncate">Molestiae
                                                            nulla maxime placeat ut quasi quibusdam.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Omnis quia tempora.</span>
                                                        <span
                                                            class="uk-text-small uk-text-muted uk-text-truncate">Eveniet
                                                            commodi et dolorum adipisci.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Molestiae in nesciunt.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Ut at
                                                            non esse.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Ut debitis.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Et
                                                            earum non tenetur expedita perferendis id.</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </li>
