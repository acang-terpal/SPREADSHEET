...
<img alt="" src="altair/assets/img/gallery/Image01.jpg" style="float:left; height:173px; margin-right:16px; margin-bottom: 16px; width:260px" />
<h1>Header</h1>
...
@section('script_bottom')
    ...
    <!-- ckeditor -->
    <script src="altair/bower_components/ckeditor/ckeditor.js"></script>
    <script src="altair/bower_components/ckeditor/adapters/jquery.js"></script>

    <!--  wysiwyg editors functions -->
    <script src="altair/assets/js/pages/forms_wysiwyg.min.js"></script>
