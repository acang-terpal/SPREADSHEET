...
<div id="page_content">
        <div id="page_content_inner">
            ...
            <textarea id="wysiwyg_tinymce" cols="30" rows="20">
...
@section('script_bottom')
    ...
    <!-- tinymce -->
    <script src="altair/bower_components/tinymce/tinymce.js"></script>

    <!--  wysiwyg editors functions -->
    <script src="altair/assets/js/pages/forms_wysiwyg.js"></script>
