    ...
    <aside id="sidebar_secondary" class="tabbed_sidebar">
                ...
                <li>
                    <div class="timeline timeline_small uk-margin-bottom">
                        ...
                        <div class="timeline_item">
                            ...
                            <div class="timeline_content">Deleted post <a href="#"><strong>Rem non odit eaque
                                        consectetur occaecati et.</strong></a></div>
                        </div>
                        <div class="timeline_item">
                                    ...
                                    <ul class="md-list md-list-addon">
                                        <li>
                                            ...
                                            <div class="md-list-content">
                                                ...
                                                <span class="uk-text-small uk-text-muted">Nesciunt enim dolores
                                                    facilis.</span>
                                            </div>
                                        </li>
                                    </ul>
                    ...
                    <ul class="md-list md-list-addon chat_users">
                        <li>
                            ...
                            <div class="md-list-content">
                                ...
                                <span class="uk-text-small uk-text-muted uk-text-truncate">Quibusdam soluta
                                    laboriosam.</span>
                            </div>
                        </li>
                        <li>
                        ...
                        <div class="chat_box chat_box_colors_a">
                            <div class="chat_message_wrapper">
                                <div class="chat_user_avatar">
                                    <img class="md-user-image" src="altair/assets/img/avatars/avatar_11_tn.png"
                                        alt="" />
                                </div>
                            ...
                            <div class="chat_message_wrapper chat_message_right">
                                <div class="chat_user_avatar">
                                    <img class="md-user-image" src="altair/assets/img/avatars/avatar_03_tn.png"
                                        alt="" />
                                </div>
                                <ul class="chat_message">
                                    <li>
        ...
        <div class="chat_submit_box">
            <div class="uk-input-group">
                <input type="text" class="md-input" name="submit_message" id="submit_message"
