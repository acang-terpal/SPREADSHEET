                                ...
                                <div class="md-card-content">
                                    <ul class="uk-tab uk-tab-grid"
                                        ...
                                        <li class="uk-width-1-2 uk-active"><a href="#"
                                                class="js-uk-prevent uk-text-small">Messages (12)</a></li>
                                        <li class="uk-width-1-2"><a href="#"
                                                class="js-uk-prevent uk-text-small">Alerts (4)</a></li>
                                    </ul>
                                            ...
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <span class="md-user-letters md-bg-cyan">tr</span>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="pages_mailbox.html">Maxime
                                                                iure.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Et neque eos distinctio
                                                            voluptas quae reprehenderit et in beatae.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="pages_mailbox.html">Inventore
                                                                est aperiam.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Delectus dolorem
                                                            blanditiis qui aut optio.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <span class="md-user-letters md-bg-light-green">jr</span>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="pages_mailbox.html">Ut
                                                                consequatur.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Ut pariatur qui ullam at
                                                            nulla aliquid laborum.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a href="pages_mailbox.html">Enim
                                                                iusto.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Eveniet fugiat distinctio
                                                            magni alias sunt ut itaque dolores tempore voluptatibus.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                    ...
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading"><a
                                                                href="pages_mailbox.html">Voluptatem voluptate.</a></span>
                                                        <span class="uk-text-small uk-text-muted">Enim dolore est aut
                                                            laborum laborum.</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        ...
                                        <li>
                                            <ul class="md-list md-list-addon">
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <i
                                                            class="md-list-addon-icon material-icons uk-text-warning">&#xE8B2;</i>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Architecto eaque.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Error
                                                            non nesciunt ipsum ullam incidunt.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <i
                                                            class="md-list-addon-icon material-icons uk-text-success">&#xE88F;</i>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Molestiae repudiandae ab.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Eos
                                                            error nesciunt sit ipsa repellat eum voluptas.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <i
                                                            class="md-list-addon-icon material-icons uk-text-danger">&#xE001;</i>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Non et.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Cumque
                                                            iusto sequi rerum tempora ratione temporibus.</span>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="md-list-addon-element">
                                                        <i
                                                            class="md-list-addon-icon material-icons uk-text-primary">&#xE8FD;</i>
                                                    </div>
                                                    <div class="md-list-content">
                                                        <span class="md-list-heading">Sapiente repudiandae.</span>
                                                        <span class="uk-text-small uk-text-muted uk-text-truncate">Maiores
                                                            totam et sequi voluptatem.</span>
                                                    </div>
                                                </li>
                                            </ul>
                                        </li>
