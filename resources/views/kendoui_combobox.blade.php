                    ...
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-large-1-2">
                            <form class="uk-form-stacked">
                                <label for="kUI_combobox_input" class="uk-form-label">From an <code>&lt;input&gt;</code>
                                    HTML element</label>
                                <input id="kUI_combobox_input" placeholder="Select fabric..."
            ...
            <div class="md-card">
                <div class="md-card-content">
                    <div class="uk-grid" data-uk-grid-margin>
                        <div class="uk-width-large-1-2">
                            <form class="uk-form-stacked">
                                <label for="kUI_combobox_select" class="uk-form-label">From an <code>&lt;select&gt;</code>
                                    HTML element</label>
                        ...
                        <div class="uk-width-large-1-2">
                            <form class="uk-form-stacked">
                                ...
                                <div class="uk-form-row">
                                    <input id="kUI_combobox_cascade_a" placeholder="Combobox A"
                                        class="uk-form-width-medium" />
                                </div>
                                <div class="uk-form-row">
                                    <input id="kUI_combobox_cascade_b" placeholder="Combobox B"
                                        class="uk-form-width-medium" />
                                </div>
                                <div class="uk-form-row">
                                    <input id="kUI_combobox_cascade_c" placeholder="Combobox C"
                                        class="uk-form-width-medium" />
                                </div>
                            </form>
                        </div>
